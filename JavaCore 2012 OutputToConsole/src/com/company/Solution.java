...
2012 OutputToConsole
The OutputToConsole class must be serialized using the Externalizable interface.
Find and fix the bug.

Requirements:
1. The Solution.OutputToConsole class must support the Externalizable interface.
2. The OutputToConsole class must be created in the Solution class.
